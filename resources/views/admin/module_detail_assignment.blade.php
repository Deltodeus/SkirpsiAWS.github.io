...
<div class="col-md-12" id="background">
    ...
    <div>
        ...
        <div style="display: flex">
            ...
            <h4 style="margin-top:30px; margin-left:2.5%; width: 80%;float:left"><a href="{{'/assignmentDetail/'.$assignment->id}}">{{$assignment->title}}</a></h4>
                ...
                <div class="modal fade" id="submitAssignment-{{ $assignment->id }}" tabindex="-1" aria-labelledby="popupmodel" aria-hidden="true">
